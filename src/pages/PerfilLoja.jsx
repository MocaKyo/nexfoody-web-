      ...
      <div style={{ padding: "0 16px", marginTop: -40, position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", alignItems: "flex-end", gap: 14, marginBottom: 16 }}>
          ...
          <div style={{ paddingBottom: 4 }}>
            <div style={{ fontFamily: "'Fraunces', serif", fontSize: "1.3rem", fontWeight: 700, color: "var(--loja-cor-primaria, var(--gold))" }}>
        ...
        <button
          ...
          style={{
            ...
            color: "var(--loja-btn-texto, #fff)", fontFamily: "'Outfit', sans-serif",

    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <img
            src="https://i.ibb.co/Z1R8Y83G/Whats-App-Image-2026-03-20-at-20-32-27.jpg"
            alt="Logo" style={{ width: 36, height: 36, borderRadius: 8, objectFit: "cover" }}
          />
          <div>
            <div style={{ fontWeight: 800, fontSize: "1rem", color: "#f5c518" }}>
              🍳 COZINHA — Açaí Puro Gosto
            </div>

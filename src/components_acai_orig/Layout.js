...
export default function Layout() {
  ...
  const navItems = [
    { path: "/",          label: "Cardápio",  icon: <IconHome /> },
    { path: "/carrinho",  label: "Pedido",    icon: <IconCart />, badge: cartCount() },
    { path: "/pontos",    label: "Pontos",    icon: <IconStar /> },
    { path: "/historico", label: "Histórico", icon: <IconHistory />, alertBadge: pedidoAtualizado },
    { path: "/conta",     label: "Social",   icon: <IconUser /> },
      ...
      <div className="app-shell">
        ...
        {showInstallBanner && (
          <div style={{
            ...
            <img src={LOGO_URL} alt="Logo" style={{ width: 36, height: 36, borderRadius: 8, objectFit: "cover" }} />
            <div style={{ flex: 1 }}>
